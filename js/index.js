...
// //自定义数组
// var selectArr = ['直播引流(招生)', '售卖录播课程', '直播带货(变现)', '直播开课培训', '综合都有', '其他需求'];
...
function telOnclick(e){
  console.log(e);
  userTel = e;
  let formmust = document.querySelector(".formMust");
...
function telOnclickTwo(e){
  console.log(e);
  userTelTwo = e;
  let formmust = document.querySelector(".formMustTwo");
  formmust.style.display = "none";
  if(userTelTwo == ''){
    formmust.style.display = "block";  
  }
...
function telPopupOnclick(e){
  console.log(e);
  userTelPopup = e;
  let formmust = document.querySelector(".formMustPopup");
  formmust.style.display = "none";
  if(userTelPopup == ''){
    formmust.style.display = "block";  
  }
